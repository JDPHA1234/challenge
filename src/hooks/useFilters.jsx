...
export function useFilters() {
    ...
    const [filters, setFilters] = useState(() =>{
        const filter = {
            ...
            contract : searchParams.get('type') || '',
    ...
    useEffect( () => {
        ...
        try {
            ...
            if (filters.location) query = query.ilike('ubicacion', `%${filters.location}%`)
            if (filters.contract) query = query.ilike('modalidad', `%${filters.contract}%`)
    ...
    useEffect(() => {
        ...
        if(filters.contract) params.set('type',filters.contract)
